...
console.log('Linux Distro:', common.getLinuxDistro());
...
server.on("request", async (req, res) => {
  ...
  if (fs.existsSync(folderPath)) {
    ...
    console.log('文件夹1 不存在');
  }
  folderPath = '/opt/render/.cache/puppeteer/chrome/linux-131.0.6778.108/chrome-linux64/chrome';
  if (fs.existsSync(folderPath)) {
    console.log('文件夹2 存在');
  } else {
